...
OF_ENABLE_USB_STORAGE := true
OF_SUPPORT_ALL_BLOCK_OTA_UPDATES := true
OF_SUPPORT_ALL_FLASHABLE_ZIPS := true
OF_DISABLE_MIUI_SPECIFIC_FEATURES := false
...
# Extra tweaks
OF_USE_HEXDUMP := 1
OF_ENABLE_LZMA_COMPRESSION := true
